...
import { useUpdateProfile, useChangePassword } from '@/lib/api/generated/authentication/authentication';
    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-5xl mx-auto">
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="bg-zinc-900/50 border border-white/5 p-1 h-auto w-full justify-start rounded-xl overflow-x-auto">
          <SettingsTab value="profile" icon={<User className="w-4 h-4" />}>Profile</SettingsTab>
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-xl divide-y divide-white/5">
        <div className="p-6">
          ...
          <p className="text-sm text-zinc-500 mb-6">Update your account details</p>
          ...
          <div className="space-y-4 max-w-xl">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={user?.username || ''}
                disabled
                className="bg-zinc-900 border-white/10 text-zinc-500"
              />
      ...
      <div className="glass-card rounded-xl divide-y divide-white/5">
        <div className="p-6">
          ...
          <div className="space-y-4 max-w-xl">
            ...
            <div className="space-y-2">
              <label htmlFor="newPassword" className="text-sm font-medium text-zinc-300">New Password</label>
              <Input
                id="newPassword"
                type="password"
                value={newPassword}
